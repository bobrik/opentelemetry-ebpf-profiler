...
var (
	...
	filterProcessAgeHelp = "Skip samples from processes younger than this duration. " +
		"Set to 0 to disable process age filtering."
...
func parseArgs() (*controller.Config, error) {
	...
	fs.DurationVar(&args.FilterProcessAge, "filter-process-age", 0, filterProcessAgeHelp)
