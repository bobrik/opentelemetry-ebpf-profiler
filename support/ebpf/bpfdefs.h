...
static inline long bpf_get_stack(UNUSED void *ctx, UNUSED void *buf, UNUSED u32 size,
                                 UNUSED u64 flags)
{
  return -1;
}
...
static long (*bpf_get_stack)(void *ctx, void *buf, u32 size, u64 flags) = (void *)BPF_FUNC_get_stack;
